...
/// <summary>
/// This is the ResourceSlot script, it contains functionality that is specific
/// to the resource slot on the UI
/// </summary>
public class ResourceSlot : MonoBehaviour,
  ...
  public virtual bool CanReceiveItem(Resource resource) { return false; }
