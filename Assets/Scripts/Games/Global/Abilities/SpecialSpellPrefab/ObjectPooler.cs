...
{
	[System.Serializable]
	public class SpellObjectPoolItem
	{
		...
		public SpellObjectPoolItem(GameObject obj, int amt, bool exp = true)
		{
			objectToPool = obj;
	...
	public class SpellObjectPooler : MonoBehaviour
	{
		public static SpellObjectPooler SharedInstance;
