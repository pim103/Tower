...
namespace Games.Global {
  ...
  public enum OriginExpulsion { Entity, SrcDamage, ForwardOfPositionSrcDamage }

  public enum DirectionExpulsion { Out, In }
  ...
  public class Effect {
    ...
    public void InitialTrigger(Entity entity) {
      ...
      case TypeEffect.BrokenDef:
        entity.def = entity.def - entity.initialDef >= 0
                         ? entity.def - entity.initialDef
                         : 0;
        entity.physicalDef =
            entity.physicalDef - entity.initialPhysicalDef >= 0
      ...
      case TypeEffect.Will:
        ...
        foreach (TypeEffect type in EffectController.ControlEffect) {
          if (entity.underEffects.ContainsKey(type)) {
            EffectController.StopCurrentEffect(entity,
                                               entity.underEffects[type]);
          }
        }
    ...
    public void TriggerEffectAtTime(Entity entity) {
      float extraDamage =
          launcher.underEffects.ContainsKey(TypeEffect.DotDamageIncrease) ? 0.2f
                                                                          : 0;
      ...
      case TypeEffect.PhysicalDefUp:
        entity.physicalDef =
            entity.underEffects.ContainsKey(TypeEffect.BrokenDef)
                ? (1 * level)
    ...
    public void EndEffect(Entity entity) {
      ...
      case TypeEffect.BrokenDef:
        entity.def = entity.underEffects.ContainsKey(TypeEffect.DefenseUp)
                         ...
                         : entity.initialDef;
        entity.magicalDef =
            entity.underEffects.ContainsKey(TypeEffect.MagicalDefUp)
                ? entity.magicalDef + entity.initialMagicalDef
                : entity.initialMagicalDef;
        entity.physicalDef =
            entity.underEffects.ContainsKey(TypeEffect.PhysicalDefUp)
                ? entity.physicalDef + entity.initialPhysicalDef
    ...
    public void UpdateEffect(Entity entity, Effect newEffect) {
      ...
      case TypeEffect.Freezing:
        ...
        if (level < 4) {
          ...
          if (level == 4) {
            Effect stunEffect =
                new Effect{typeEffect = TypeEffect.Stun, level = 1,
                           durationInSeconds = 1, launcher = entity};
