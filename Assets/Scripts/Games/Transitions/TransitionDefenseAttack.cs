      ...
      foreach(var gridCell in initDefense.gridCellList) {
        ...
        if (cellController.contentType != GridTileController.TypeData.Empty) {
          ...
          case GridTileController.TypeData.Group:
            CardBehavior currentCardBehavior =
                cellController.content.GetComponent<CardBehavior>();
            stringToSend += "1:" + currentCardBehavior.groupId + ":[";
            if (currentCardBehavior.meleeWeaponSlot) {
              stringToSend += currentCardBehavior.meleeWeaponSlot
                                  .GetComponent<CardBehavior>()
                                  .equipement.id +
                              ",";
            } else {
              stringToSend += "0,";
            ...
            if (currentCardBehavior.rangedWeaponSlot) {
              stringToSend += currentCardBehavior.rangedWeaponSlot
                                  .GetComponent<CardBehavior>()
                                  .equipement.id +
                              ",";
            } else {
            ...
            if (currentCardBehavior.helmetSlot) {
              stringToSend +=
                  currentCardBehavior.helmetSlot.GetComponent<CardBehavior>()
                      .equipement.id +
                  ",";
            } else {
              stringToSend += "0,";
            ...
            if (currentCardBehavior.chestSlot) {
              stringToSend +=
                  currentCardBehavior.chestSlot.GetComponent<CardBehavior>()
                      .equipement.id +
                  ",";
            } else {
              stringToSend += "0,";
            ...
            if (currentCardBehavior.grievesSlot) {
              stringToSend +=
                  currentCardBehavior.grievesSlot.GetComponent<CardBehavior>()
                      .equipement.id;
            } else {
              stringToSend += "0";
            }
