...
namespace Games.Players {
  public enum Classes { Warrior, Ranger, Rogue, Mage }
  ...
  public class Player : Entity {
    ...
    public override void BasicAttack() { playerPrefab.PlayBasicAttack(); }

    public override void BasicDefense() {
      Effect regen =
          new Effect{typeEffect = TypeEffect.Regen, launcher = this, level = 1,
                     durationInSeconds = 5f, ressourceCost = 1};
      Effect invisible =
          new Effect{typeEffect = TypeEffect.Invisibility, launcher = this,
                     level = 1, durationInSeconds = 5f, ressourceCost = 1};
      ...
      switch (mainClass) {
        ...
        //                case Classes.Ranger:
        //                    if
        //                    (!underEffects.ContainsKey(TypeEffect.MadeADash)
        //                    && ressource1 > 10)
        //                    {
        //                        ressource1 -= 10;
        //
        ...
        //                        BasicAttack();
        //
        //                        EffectController.ApplyNewEffectToEntity(this,
        //                        TypeEffect.MadeADash, 0.2f);
        //                    }
        //                    break;
    ...
    public override void DesactiveBasicDefense() {
      ...
      //            {
      //                case Classes.Mage:
      //                    EffectController.RemoveEffect(this,
      //                    TypeEffect.Regen); break;
      //                case Classes.Rogue:
      //                    EffectController.RemoveEffect(this,
      //                    TypeEffect.Invisibility); break;
      //                case Classes.Ranger:
      //                    break;
      //                case Classes.Warrior:
      //                    nbShieldBlock = 0;
    ...
    public void InitPlayerStats(Classes classe) {
      ...
      InitEntityList();
      int idWeapon = GetIdWeaponFromCategory(
          ChooseDeckAndClass.currentWeaponIdentity.categoryWeapon);
      InitWeapon(idWeapon);
