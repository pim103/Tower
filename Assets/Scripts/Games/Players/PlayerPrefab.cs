...
namespace Games.Players {
  public class PlayerPrefab : PlayerIntent {
    ...
    public Text timer3;
    [SerializeField]
    public GameObject bgTimer1;
    [SerializeField]
    public GameObject bgTimer2;
    [SerializeField]
    public GameObject bgTimer3;
      ...
      if (!intentBlocked) {
        ...
        if (!entity.doingSkill && !entity.isSilence) {
          ...
          if (Input.GetKeyUp(KeyCode.Alpha1)) {
            SpellController.CastSpell(entity, entity.spells[0], positionPointed,
                                      target, 1);
          }

          if (Input.GetKeyUp(KeyCode.Alpha2)) {
            SpellController.CastSpell(entity, entity.spells[1], positionPointed,
                                      target, 2);
          }

          if (Input.GetKeyUp(KeyCode.Alpha3)) {
            SpellController.CastSpell(entity, entity.spells[2], positionPointed,
                                      target, 3);
          }
        }
      }
    ...
    private void CameraRotation() {
      ...
      if (Physics.Raycast(ray, out hit, 1000,
                          ~LayerMask.GetMask("Player", "Spell", "Weapon"))) {
