...
public class ArmorEditor : IEditorInterface {
  ...
  private void DisplayOneArmorEditor(Armor armor) {
    ...
    armor.equipmentName =
        EditorGUILayout.TextField("Name", armor.equipmentName);
    armor.def = EditorGUILayout.IntField("Damage", armor.def);
    armor.armorCategory = (CategoryArmor) EditorGUILayout.EnumPopup(
        "Category", armor.armorCategory);
    ...
    armor.sprite = (Texture2D) EditorGUILayout.ObjectField(
        armor.sprite, typeof(Texture2D), false);
