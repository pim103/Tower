...
public class MainMenu : MonoBehaviour, MenuInterface {
  ...
  private void Start() {
    ...
    craftButton.onClick.AddListener(
        delegate { mc.ActivateMenu(MenuController.Menu.Craft); });

    deckButton.onClick.AddListener(
        delegate { mc.ActivateMenu(MenuController.Menu.DeckManagement); });

    settingsButton.onClick.AddListener(
        delegate { mc.ActivateMenu(MenuController.Menu.Settings); });
    /*
    ...
    */
    shopButton.onClick.AddListener(
        delegate { mc.ActivateMenu(MenuController.Menu.Shop); });
  ...
  public void InitMenu() { Debug.Log("Main Menu"); }
}
}