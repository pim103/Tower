...
public class RegistrationMenu : MonoBehaviour, MenuInterface {
  ...
  private void Start() {
    ...
    createButton.onClick.AddListener(delegate { CallRegister(); });

    returnButton.onClick.AddListener(
        delegate { mc.ActivateMenu(MenuController.Menu.Connection); });
  }
  ...
  IEnumerator Register() {
    ...
    var www = UnityWebRequest.Post(
        NetworkingController.PublicURL + "/services/account/add.php", form);
