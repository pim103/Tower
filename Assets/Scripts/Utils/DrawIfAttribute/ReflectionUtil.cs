...
public static class ReflectionUtil {
  ...
  GetAllTypesWithAttributeAsEnumerable(this Assembly assembly, Type attribute) {
  ...
  public static Type[] GetAllTypesWithAttribute(this Assembly assembly,
                                                Type attribute) {
...
#region Get Variable Methods
  ...
  /// <param name="bindingFlags">Filters for the field/property it can find.
  /// (optional)</param> <returns>The field/property.</returns>
  public static T
  GetFieldOrProperty<T>(this object obj, string name,
    ...
    try {
      ...
      //...try getting the property. If that wasn't found as well, throw an
      //exception
      try {
        return GetProperty<T>(obj, name, bindingFlags);
      } catch (PropertyNotFoundException) {
        throw new PropertyOrFieldNotFoundException(
            "Couldn't find a filed nor a property with the name of '" + name +
            "' inside of the object '" + obj.GetType().Name + "'");
      }
    }
  }
  ...
  /// <param name="bindingFlags">Filters for the fields it can find.
  /// (optional)</param> <returns>The field.</returns>
  public static T
  GetField<T>(this object obj, string name,
    ...
    throw new FieldNotFoundException(
        "Couldn't find a field with the name of '" + name +
        "' inside of the object '" + obj.GetType().Name + "'");
  }
  ...
  /// <param name="bindingFlags">Filters for the properties it can find.
  /// (optional)</param> <returns>The property.</returns>
  public static T
  GetProperty<T>(this object obj, string name,
    ...
    throw new PropertyNotFoundException(
        "Couldn't find a property with the name of '" + name +
        "' inside of the object '" + obj.GetType().Name + "'");
  }
...
#region Set Variable Methods
  ...
  /// (optional)</param>
  public static void
  SetFieldOrProperty<T>(this object obj, string name, T value,
                        BindingFlags bindingFlags = BindingFlags.Instance |
                                                    BindingFlags.Public |
                                                    BindingFlags.NonPublic) {
    try {
  ...
  /// (optional)</param>>
  public static void
  SetField<T>(this object obj, string name, T value,
              BindingFlags bindingFlags = BindingFlags.Instance |
                                          BindingFlags.Public |
                                          BindingFlags.NonPublic) {
    // Try getting the field and returning it.
  ...
  /// (optional)</param>
  public static void
  SetProperty<T>(this object obj, string name, T value,
                 BindingFlags bindingFlags = BindingFlags.Instance |
                                             BindingFlags.Public |
                                             BindingFlags.NonPublic) {
    // Try getting the field and returning it.
...
#region Get All Variables Methods
  ...
  /// <param name="bindingFlags">Filters for the types of fields/properties that
  /// can be found.</param> <returns>The fields/properties found.</returns>
  public static IEnumerable<T> GetAllFieldsOrProperties<T>(
      this object obj, BindingFlags bindingFlags = BindingFlags.Instance |
                                                   BindingFlags.Public |
                                                   BindingFlags.NonPublic) {
    ...
    if (properties != null && properties.Length != 0) {
      // Loop through the properties and return each one if they have the right
      // type.
  ...
  GetAllFieldsOrProperties(this object obj,
                           BindingFlags bindingFlags = BindingFlags.Instance |
                                                       BindingFlags.Public |
                                                       BindingFlags.NonPublic) {
    // Get the fields and the properties in the object.
    ...
    object[] properties =
        obj.GetAllProperties(bindingFlags).Cast<object>().ToArray();
  ...
  GetAllFields<T>(this object obj,
                  BindingFlags bindingFlags = BindingFlags.Instance |
                                              BindingFlags.Public |
                                              BindingFlags.NonPublic) {
  ...
  public static IEnumerable<T>
  GetAllProperties<T>(this object obj,
                      BindingFlags bindingFlags = BindingFlags.Instance |
                                                  BindingFlags.Public |
                                                  BindingFlags.NonPublic) {
    // Get all the properties.
    ...
    // If there are properties in the array, return each element.
    for (int i = 0; i < properties.Length; i++) {
      object currentValue = properties [i]
                                .GetValue(obj, null);
  ...
  /// <returns>The properties found.</returns>
  public static IEnumerable
  GetAllProperties(this object obj,
                   BindingFlags bindingFlags = BindingFlags.Instance |
                                               BindingFlags.Public |
                                               BindingFlags.NonPublic) {
    // Get all the properties.
