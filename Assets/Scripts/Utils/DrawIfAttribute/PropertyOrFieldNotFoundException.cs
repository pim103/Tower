...
/// <summary>
/// An exception that is thrown whenever a field or a property was not found
/// inside of an object when using Reflection.
/// </summary>
[Serializable]
public class PropertyOrFieldNotFoundException : Exception {
  ...
  public PropertyOrFieldNotFoundException(string message, Exception inner)
      : base(message, inner) {}
