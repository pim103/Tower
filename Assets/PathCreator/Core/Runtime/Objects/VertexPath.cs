...
namespace PathCreation {
    ...
    public class VertexPath {
        ...
        public Vector3[] localPoints { get; set; }
        public Vector3[] localTangents { get; set; }
        public Vector3[] localNormals { get; set; }
        ...
        public float[] cumulativeLengthAtEachVertex { get; set; }
